...
export class UpdateAiPromptConfigDto {
  @ApiPropertyOptional({
    ...
    example: 'We are a SaaS billing platform for B2B companies. Core features: invoicing, subscriptions, payment processing.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(2000)
  ...
  @ApiPropertyOptional({
    ...
    example: 'Focus on security vulnerabilities. Our critical components are: auth, billing, webhooks.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(2000)
  ...
  @ApiPropertyOptional({
    ...
    example: 'Classify payment-related issues as critical severity. Feature requests about reporting should be marked as high priority.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(2000)
  ...
  @ApiPropertyOptional({
    ...
    example: 'Always check the billing module first for payment issues. Our webhook handler is in src/webhooks/.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(2000)

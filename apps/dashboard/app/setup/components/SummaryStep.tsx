    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Review your configuration and launch the platform.
        </p>
      </div>
      ...
      <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        <div className="flex items-center mb-4">
          <svg className="w-8 h-8 text-blue-600 dark:text-blue-400 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <p className="text-sm text-blue-700 dark:text-blue-300">
          Your Support Helper platform is configured and ready to use. Review the settings below and click Launch to get started.
        </p>
      </div>

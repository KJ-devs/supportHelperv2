    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Enter your OpenAI API key to enable AI-powered features like automatic ticket analysis and classification.
        </p>
      </div>

      <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
        <p className="text-sm text-blue-700 dark:text-blue-300">
          <strong>Note:</strong> You can skip this step and configure the AI API key later in the settings.
          However, AI features will not be available until you provide a valid key.
        </p>
      </div>

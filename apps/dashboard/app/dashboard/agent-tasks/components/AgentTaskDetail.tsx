...
// ---- Tab: Overview ----
function OverviewTab({ task }: { task: AgentTask }) {
  return (
    <div className="space-y-6">
      ...
      {task.prUrl && (
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
          <h4 className="text-sm font-medium text-green-800 dark:text-green-300 mb-2">Pull Request</h4>
          <a
            href={task.prUrl}
            target="_blank"
      ...
      {task.ciErrorLog && (
        <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
          <h4 className="text-sm font-medium text-orange-800 dark:text-orange-300 mb-2">CI Error Log</h4>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Estimated Complexity:</span>
      ...
      {plan.testingStrategy && (
        <div>
          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Testing Strategy</h4>
          <p className="text-sm text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
            {plan.testingStrategy}
          </p>
        </div>
...
// ---- Tab: Execution Logs ----
function LogsTab({ logs }: { logs: ExecutionLogEntry[] }) {
    ...
    <div className="space-y-2">
      {logs.map((entry, idx) => (
        ...
        >
          ...
          <span className="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
            {entry.step}
          </span>
...
// ---- Main Component ----
export function AgentTaskDetail({ task }: AgentTaskDetailProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow">
      ...
      <div className="p-6">
        ...
        {activeTab === 'logs' && <LogsTab logs={task.executionLog} />}

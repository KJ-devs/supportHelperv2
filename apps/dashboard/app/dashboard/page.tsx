...
function KpiCard({ icon, label, value, subtitle, borderColor }: KpiCardProps) {
  return (
    <div className={`bg-white dark:bg-gray-900 rounded-lg shadow dark:shadow-gray-800/20 p-5 border-l-4 ${borderColor}`}>

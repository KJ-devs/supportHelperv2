  ...
  return (
    <div className="bg-white rounded-lg shadow border border-gray-200 p-6 hover:shadow-md transition-shadow">
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 font-mono text-sm bg-gray-50 px-3 py-2 rounded border border-gray-200 overflow-hidden">
      ...
      <div className="mb-4 p-3 bg-blue-50 rounded-lg">
        <div className="flex items-center justify-between">
          <span className="text-sm text-gray-700">Tickets créés</span>
        ...
        <div className="mb-4 text-sm text-gray-600">
          <div className="flex flex-wrap gap-2">
            {application.settings.recordVideo && (
              <span className="px-2 py-1 bg-gray-100 rounded">🎥 Vidéo</span>
            )}
            {application.settings.captureLogs && (
              <span className="px-2 py-1 bg-gray-100 rounded">📝 Logs</span>
            )}
            {application.settings.autoAssign && (
              <span className="px-2 py-1 bg-gray-100 rounded">🤖 Auto-assign</span>
            )}
          </div>
        </div>
      )}

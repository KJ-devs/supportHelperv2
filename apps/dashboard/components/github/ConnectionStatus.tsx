...
export function ConnectionStatus({
  ...
  const t = useTranslations('githubConnection');
  ...
  return (
    <Card>
      <div className="flex items-center justify-between">
          ...
          <div>
            ...
            {connectedAt && (
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                {t('connectedSince', {
                  date: new Date(connectedAt).toLocaleDateString(undefined, {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric',
                  }),
        ...
        <Button variant="danger" onClick={onDisconnect} isLoading={isDisconnecting}>
          {t('disconnect')}
        </Button>
      </div>
    </Card>
